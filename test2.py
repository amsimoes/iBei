...
class Client(object):
    def __init__(self, ip='localhost', port=1099, name='c'):
        self.ok = 'false'
...
if __name__ == '__main__':
    ...
    print "items_count > 0 | items_0_code ="+p1_code+" items_0_title ="+p1_title
    print resp
    print s.summary()
    ...
    print "bids_count == 0, messages count == 0, code="+p1_code+" title="+p1_title
    print resp
    print s.summary()
    ...
    print "items_count == 1, items_0_code="+p1_code+" items_0_title="+p1_title
    print resp
    print s.summary()
    ...
    print "20 - detail_auction"
    print "messages_count = 1"
    print resp
    print s.summary()
